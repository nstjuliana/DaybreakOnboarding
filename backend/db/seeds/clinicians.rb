...
clinicians_data = [
  {
    ...
    specialties: %w[anxiety depression adolescents family_therapy],
    status: 'active'
  },
  {
    first_name: 'Michael',
    ...
    specialties: %w[anxiety depression behavioral_issues teens cbt dbt],
    status: 'active'
  },
  {
    first_name: 'Emily',
    ...
    specialties: %w[family_therapy adolescents mood_disorders life_transitions],
    status: 'active'
  },
  {
    first_name: 'David',
    ...
    specialties: %w[children anxiety adhd social_skills play_therapy],
    status: 'active'
  },
  {
    first_name: 'Aisha',
    ...
    specialties: %w[trauma anxiety depression teens cultural_sensitivity],
    status: 'active'
  }
]
...
clinicians_data.each do |data|
  ...
  puts "  Created/Updated clinician: #{clinician.display_name}"
end

puts "Seeded #{Clinician.count} clinicians."
