...
| CRITICAL | suicide, self-harm explicit | Immediate safety pivot |

| HIGH | abuse, self-harm ideation | Safety resources shown |

| MEDIUM | hopeless, worthless | Monitor, empathetic response |
...
| Database | 4 migrations | schema.rb |

| Models | 4 (Conversation, Message, CrisisEvent, ScreenerResponse) | Assessment |

| Services | 8 | - |

| Controllers | 2 | routes.rb |

| Jobs | 2 | good_job.rb |

| Frontend Components | 10 | phase-2/page.tsx |

| Hooks | 2 | - |

| Constants/Prompts | 6 | phases.ts |---
...
- Fit determination routes users correctly (Phase 3 or Off-ramp)